...
import iconHealthLifestyle from 'app/src/icon-salud-suplementación.png'
    ...
    return (
      <Page style={[styles.isPaddingless]}>
        ...
        <View style={[styles.isMargin]}>
          <Text style={[styles.textCentered, styles.fontWhite18, stylesNutrition.title]}>HÁBITOS SALUDABLES</Text>
          <Panel
            title={title}
