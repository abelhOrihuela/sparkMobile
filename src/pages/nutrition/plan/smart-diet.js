      ...
      <View style={{flex: 1}}>
        ...
        <Panel
          ...
          <Text style={[styles.isGinoraFontRegular, styles.isMarginSmallTopBottom]}>
            ...
            Para controlar el tamaño de tus porciones, te mostramos el <Text style={[styles.isAdamFontRegular]}>ALCHE<Text style={[styles.isBold]}>MY</Text>PLATE</Text>. En él podrás crear tu propio plato de
