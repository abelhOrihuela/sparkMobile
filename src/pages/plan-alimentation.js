...
export default class PlanAlimentation extends Component {
  ...
  render () {
    ...
    return (
      <Page>
        <Text style={[{margin: 10}, styles.fontBlack16Bold, styles.fontGinora]}>Plan de Alimentación SMART DIET</Text>
        <Text style={[{margin: 10}, styles.fontBlack14]}>La Smart Diet es perfecta para impulsar el bienestar de personas sanas y sin ninguna enfermedad o condición especial, ¡cómo tú! </Text>
        <Text style={[{margin: 10}, styles.fontBlack14]}>Este tipo de alimentación es equilibrada, variada y contiene una elevada dosis de antioxidantes.</Text>
        <Text style={[{margin: 10}, styles.fontBlack16Bold]}>PRODUCTOS NATURALES Y FRESCOS.</Text>
        ...
        <Text style={[{margin: 10}, styles.fontBlack14Bold]}>
